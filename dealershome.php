        ...
        <div id="content">
            ...
            <div class="container">
                <div class="col-md-12">
                    <div id="main-slider">
                        <div class="item">
                            <img src="img/CarY.jpg" alt="" class="img-responsive">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="img/CarX.jpg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="img/CarZ.jpg" alt="">
                        </div>
                    ...
                    <div class="same-height-row">
                        ...
                        <div class="col-sm-4">
                            <div class="box same-height clickable">
                                ...
                                <p>With help of our Seller and Dealer we can give the best Price available in the market.</p>
                            </div>
                        </div>
         ...
         <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    ...
                                    <p class="price">BIRR : <?php echo number_format($row5['CurrentPrice'],2)?></p>

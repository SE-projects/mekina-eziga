...
$deal=$_SESSION['dealer_id'];
        ...
        {
            $newuser = "INSERT INTO user (Username, Password, Contact_No, Address, FName, LName,userType_id,dealers_id)
                        VALUES ('$username', '$password', $cno, '$addr', '$fname', '$lname','$utype','$deal ')";

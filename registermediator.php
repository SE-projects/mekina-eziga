            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        ...
                        <form action="process_sregister.php" method="post">
                            ...
                            <div class="form-group">
                                            ...
                                            <p>What are you</p>
                                                <label class="radio inline"> 
                                                    <input type="radio" name="Team" value="5" checked>
                                                    <span> Financial Team Member </span> 
                                                </label>
                                                <label class="radio inline"> 
                                                    <input type="radio" name="Team" value="6">
